...
jQuery(document).ready(function($) {
  ...
  colWidth = function () {
    ...
    $container.find('.item').each(function() {
      ...
      width = multiplier_w ? columnWidth*multiplier_w[1]*0.96-10 : columnWidth*0.96-10,
      height = multiplier_h ? columnWidth*multiplier_h[1]*0.94-10 : columnWidth*0.94-10;
      $item.css({
        width: width,
        height: height
      });
